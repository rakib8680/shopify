...
const TShirt = ({ tshirt, handleCart }) => {
    ...
    return (
        <div className='border p-5 rounded-lg'>
            ...
            <button className='bg-amber-800 font-semibold px-3 py-1 rounded-md text-amber-400 mt-2 hover:bg-amber-400 hover:text-amber-800 transition duration-300' onClick={() => handleCart(tshirt)}>Buy Now</button>
        </div>
    );
};
